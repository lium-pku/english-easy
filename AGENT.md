...
英语词汇量测试 Web 应用。采用分层抽样（Stratified Sampling）方法，覆盖 40,000 词汇量，通过四选一英文释义匹配题型估算测试者的英语词汇量。
